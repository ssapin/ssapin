...
public class UserController {
    ...
    public ResponseEntity<?> checkNickname(@RequestBody UserRequest.Check request) {
        return new ResponseEntity<>(userService.countUserByNickname(request.getNickname()), HttpStatus.OK);
    }
